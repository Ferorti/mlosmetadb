...
```csv
R1-ACT-01a,1,devolucion/action_matrix.csv:1,"Normalizar a una fila por (proteína, recurso, MLO, rol)",refutado,"35.968 filas totales = 35.968 claves distintas (uniprot_id, source_db, source_mlo, source_role) en la base viva; la propiedad quedó establecida en 2894fad, donde eran 35.971 = 35.971. FUS/P35637 tiene 5 filas de stress_granule y no 119","Ya cierto antes de recibir la devolución; ver mlo_mapping_decisions.md §11",2894fad,si
