      ...
      <div class="flex items-center gap-4">
        ...
        <div class="flex flex-col gap-2">
          <a
            ...
            class="w-23 inline-flex items-center justify-center gap-1.5 px-3 py-1 rounded bg-[#185FA5] text-white text-sm font-medium hover:bg-[#0F4A87] transition-colors"
          >JSON
