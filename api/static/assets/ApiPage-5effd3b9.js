import{o as s,b as a,d as t,t as r,F as n,i,I as u}from"./index-a3f0d64f.js";const c={class:"max-w-6xl mx-auto px-6 py-8"},g={class:"mb-8"},x={class:"overflow-x-auto border border-gray-200 rounded-lg"},h={class:"w-full text-sm"},b={class:"px-4 py-2 font-mono text-[#185FA5]"},_={class:"px-4 py-2 font-mono text-gray-800"},f={class:"px-4 py-2 text-gray-600"},y={class:"mb-8"},v={class:"overflow-x-auto border border-gray-200 rounded-lg mt-3"},E={class:"w-full text-sm"},P={class:"px-4 py-2 text-gray-600"},w={class:"px-4 py-2 font-mono text-gray-800"},A={class:"px-4 py-2 font-mono text-[#185FA5]"},l="https://mlos.leloir.org.ar/api",F=`{
  "uniprot_id": "A1ZBW4",
  "gene_name": "HnRNP-K",
  "protein_name": null,
